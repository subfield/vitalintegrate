    ...
    <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
            <Link to="/" title="" className="flex items-center space-x-2">
                        <img className="w-auto h-10" src={logo.icon} alt="logo icon" /> <span className="logoFont tracking-wider text-2xl cursor-pointer">{siteName}</span>
                    </Link>
            ...
            <div className="flex flex-wrap justify-center mt-6 -mx-4">
                ...
                <a href="#" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Contact Us </a>
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <p className="text-sm text-gray-500 dark:text-gray-300">© Copyright 2021. <span className="logoFont px-0.5">{siteName}</span> - All Rights Reserved.</p>
